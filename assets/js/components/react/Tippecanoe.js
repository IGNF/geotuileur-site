...
class TippeCanoe extends React.Component {
    constructor(props) {
        super(props);
...
export class TippeCanoeList extends React.Component {
    constructor(props) {
        ...
        let entry = Object.entries(this.props).find(([key, tippecanoe]) => { // eslint-disable-line no-unused-vars
