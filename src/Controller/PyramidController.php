    ...
    private function getGeneralizations()
    {
        ...
        return [
            '--simplification=10' => [
                ...
                'default' => true,
                'image_0' => "$path/simplify_forms_before.png",
                'image_1' => "$path/simplify_forms_after.png",
            ],
            '--no-simplification-of-shared-nodes --simplification=15' => [
                ...
                'image_0' => "$path/keep_nodes_before.png",
                'image_1' => "$path/keep_nodes_after.png",
            ],
            ...
            '--grid-low-zooms –D8 --simplification=15' => [
                ...
                'image' => "$path/keep_cover_merged.png",
            ],
            '--coalesce --coalesce-densest-as-needed --drop-smallest-as-needed --simplification=15' => [
                ...
                'image_0' => "$path/keep_densest_delete_smallest_before.png",
                'image_1' => "$path/keep_densest_delete_smallest_after.png",
            ],
            '--coalesce --drop-smallest-as-needed --simplification=10' => [
                ...
                'image_0' => "$path/merge_same_attributes_and_simplify_before.png",
                'image_1' => "$path/merge_same_attributes_and_simplify_after.png",
            ],
            '--detect-shared-borders --simplification=20' => [
                ...
                'image_0' => "$path/keep_shared_edges_before.png",
                'image_1' => "$path/keep_shared_edges_after.png",
            ],
        ];
    }
